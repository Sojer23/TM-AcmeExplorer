...
public final class Constants {
    ...
    //TRIP ACTIVITY
    public final static String[] cities = {"Tirana", "Berlín", "Andorra La Vella", "Ereván", "Vienna", "Bakú", "Bruselas", "Minsk", "Sarajevo", "Sofía", "Praga", "Zagreb", "Copenhagen", "Bratislava", "Madrid", "Tallín", "Helsinki", "París", "Tiflis", "Atenas", "Budapest", "Dublin", "Reykjavik", "Rome", "Riga", "Vaduz", "Vilna", "Luxemburgo", "Skopje", "La Valeta", "Chisinau", "Monaco", "Podgorica", "Oslo", "Amsterdam", "Varsovia", "Lisboa", "Londres", "Bucharest", "Moscow", "San Marino", "Belgrado", "Stockholm", "Berna", "Kiev"};
