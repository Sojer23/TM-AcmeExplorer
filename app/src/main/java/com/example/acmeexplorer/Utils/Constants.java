...
public final class Constants {
    ...
    //TRIP ACTIVITY
    public final static String[] cities = {"Tirana", "Berlín", "Andorra La Vieja", "Ereván", "Viena", "Bakú", "Bruselas", "Minsk", "Sarajevo", "Sofía", "Praga", "Zagreb", "Copenhague", "Bratislava", "Lublijana", "Madrid", "Tallín", "Helsinki", "París", "Tiflis", "Atenas", "Budapest", "Dublín", "Reikiavik", "Rome", "Riga", "Vaduz", "Vilna", "Luxemburgo", "Skopje", "La Valeta", "Chisinau", "Mónaco", "Podgorica", "Oslo", "Amsterdam", "Varsovia", "Lisboa", "Londres", "Bucarest", "Moscú", "San Marino", "Belgrado", "Estocolmo", "Berna", "Kiev", "Ciudad Del Vaticano"};
